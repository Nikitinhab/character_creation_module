...
def attack(char_name: str, char_class: str) -> str:
    """Функция возвращает величину очков атаки.
    Величина зависит от выюранного персонажа.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """Функция возвращает величину очков заблокированного урона.
    Величина зависит от выбранного персонажа.
    """
    if char_class == 'warrior':
    ...
    return (f'{char_name} незаблокировал урон')


def special(char_name: str, char_class: str) -> str:
    """Функция возвращает величину очков специального умения.
    Величина зависит от от выбранного персонажа.
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    ...
    Так же запускает или пропускает режим тренировки.
    """
    if char_class == 'warrior':
